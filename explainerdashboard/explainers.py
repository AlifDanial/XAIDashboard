...
class BaseExplainer(ABC):
    ...
    def mean_abs_shap_df(self, pos_label=None):
        """mean absolute Impact values per feature."""
    ...
    def get_mean_abs_shap_df(self, topx=None, cutoff=None, pos_label=None):
        ...
        returns a pd.DataFrame with the mean absolute Impact values per features,
    ...
    def plot_importances(self, kind='shap', topx=None,  round=3, pos_label=None):
        ...
        Args:
          type(str, optional): shap' for mean absolute Impact values, 'permutation' for
        ...
        if kind=='shap':
            if self.target: 
                title = f"Average impact on predicted {self.target}<br>(mean absolute Impact value)"
            else:
                title = 'Average impact on prediction<br>(mean absolute Impact value)' 
    ...
    def plot_importances_detailed(self, highlight_index=None, topx=None, max_cat_colors=5, 
        ...
        """Plot barchart of mean absolute Impact value.
        
        Displays all individual shap value for each feature in a horizontal
        scatter chart in descending order by mean absolute Impact value.
    ...
    def plot_interactions_detailed(self, col, highlight_index=None, topx=None, 
        ...
        horizontal scatter chart in descending order by mean absolute Impact value.
