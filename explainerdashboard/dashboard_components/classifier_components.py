...
class ConfusionMatrixComponent(ExplainerComponent):
    ...
    def __init__(self, explainer, title="Confusion Matrix", name=None,
        ...
        The confusion matrix shows the number of TRUE NEGATIVES (predicted negative, actual negative), 
        TRUE POSITIVES (predicted positive, actual positive), 
        FALSE NEGATIVES (predicted negative, but actual positive) and
        FALSE POSITIVES (predicted positive, but actual negative). The amount
